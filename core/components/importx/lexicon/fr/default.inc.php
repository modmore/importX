...
$_lang['importx.tab.input.desc'] = 'Collez votre texte brut ici. Chaque entrée doit être sur une ligne et les champs doivent être délimités par un point-virgule (;), ou tout autre délimiteur spécifié dans le champ « séparateur » ci-dessous.';
