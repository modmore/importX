...
$_lang['importx.tab.input.desc'] = 'Plak hier je invoer, waarbij aparte resources gescheiden zijn door een enter en de verschillende velden met een puntkomma (;) of het scheidingsteken wat je beneden aangegeven hebt.';
...
$_lang['importx.err.parentnotnumeric'] = 'Bovenliggend resource moet een cijfer zijn.';
...
$_lang['importx.log.importvaluesclean'] = 'Geen fouten in import waardes gevonden. Importeren...';
